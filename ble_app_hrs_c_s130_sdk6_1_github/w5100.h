...
// Defines SPI ETHERNET SETTINGS: 4 000 000, MSBFIRST, SPI_MODE0?
...
void W5100Class_initSS(W5100Class *w5100) {
    
}

void W5100Class_init(W5100Class *w5100) {
    // delay(300); ?? Why?
    
//  SPI.begin(); // Start SPI transfer
//  initSS();
